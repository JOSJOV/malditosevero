...
<div style="display: flex; align-items: flex-start;">
    <img src="img/manana.jpg" alt="Mañana, mañana y mañana" style="margin-right: 40px; width: 220px;"/>
    <div>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/valle.jpg" alt="Valle inquietante" style="margin-right: 40px; width: 220px;"/>
    <div>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/adventuresit.jpg" alt="The Adventures of an IT Leader" style="margin-right: 40px; width: 220px;"/>
    <div>
        <strong>Título:</strong> Valle inquietante<br>
        <strong>Autor:</strong> Robert D. Austin, Richard L. Nolan, Shannon O'Donnell<br>
        <strong>Editorial:</strong> Harvard Business Review<br>
        <strong>Año edición española:</strong> No disponible<br>
        Publicación original: 2016<br><br>
        
		<strong>Reseña:</strong>
		<a href="https://blogs.uoc.edu/informatica/es/las-aventuras-de-jim-barton/">UOC</a><br><br>

Jim Barton, nuevo CIO de la información y de las TIC, le previene su antecesor «Aquí no durarás un año».
Vive una crisis con caída de todos los sistemas, mentiras de los proyectos fallidos, 
trato con los clientes internos y partners, preguntas metafísicas sobre el coste de la informática, 
y cómo manejar a los raros de los ingenieros TIC.
    </div>
</div>
<br>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/elcirculo.jpg" alt="El círculo" style="margin-right: 40px; width: 220px;"/>
    <div>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/readme.jpg" alt="Reamde" style="margin-right: 40px; width: 220px;"/>
    <div>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/jpod.jpg" alt="JPod" style="margin-right: 40px; width: 220px;"/>
    <div>
...
<br>
<div style="display: flex; align-items: flex-start;">
    <img src="img/microsiervos.jpg" alt="Microsiervos" style="margin-right: 40px; width: 220px;"/>
    <div>
